<template>
  <section class="st__hero">
    <div class="container mx-auto p-5">
      ...
      <img
        class="about__hero__img"
        src="/about_img/about__hero__bg.png"
        alt="foto"
      />
      <img
        class="about__hero__img2"
    ...
    <div class="container">
      <div class="dev__ab">
        ...
        <div class="dev__av__content">
          ...
          <button data-aos-duration="1500" data-aos="fade-left">
            {{ $t("section4-btn") }}
          </button>
        </div>
      </div>
      <button id="team__btn" class="sm:ml-0 ml-5 mt-20">
        <img src="/about_img/Phone.png" alt="icon" />
        {{ $t("Hero-brn-mobile") }}
      </button>
    ...
    <div class="container mx-auto p-5">
      ...
      <div class="form__wrapper">
        ...
        >
          ...
          <button required class="form__btn" type="submit">{{ $t("section8-btn") }}</button>
        </form>
        <div
          data-aos-duration="1500"
          ...
          data-aos-delay="300"
          data-aos-offset="0"
          class="form__img lg:block hidden"
        >
